...
El principio del mínimo nos permitirá demostrar que el sistema dado por \eqref{eq:lap} no tiene más de una solución. Para problemas lineales con igual número (finito) de ecuaciones e incógnitas, esto equivale a decir que el sistema de hecho siempre tiene solución.
