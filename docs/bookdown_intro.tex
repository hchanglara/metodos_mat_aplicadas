...
\NormalTok{x1,y1}\OperatorTok{=}\NormalTok{r[}\DecValTok{0}\NormalTok{],r[}\DecValTok{1}\NormalTok{]}
\NormalTok{x2,y2}\OperatorTok{=}\NormalTok{r[}\DecValTok{2}\NormalTok{],r[}\DecValTok{3}\NormalTok{]}

\NormalTok{fig, ax }\OperatorTok{=}\NormalTok{ plt.subplots()}
\NormalTok{ax.plot([}\DecValTok{0}\NormalTok{,r[}\DecValTok{0}\NormalTok{],r[}\DecValTok{2}\NormalTok{],x3], [}\DecValTok{0}\NormalTok{,r[}\DecValTok{1}\NormalTok{],r[}\DecValTok{3}\NormalTok{],y3])}
\NormalTok{ax.plot(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,color}\OperatorTok{=}\StringTok{\textquotesingle{}tab:blue\textquotesingle{}}\NormalTok{, marker}\OperatorTok{=}\StringTok{\textquotesingle{}o\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}$q\_0=(0,0)$\textquotesingle{}}\NormalTok{)}
\NormalTok{ax.plot(x1,y1,color}\OperatorTok{=}\StringTok{\textquotesingle{}tab:orange\textquotesingle{}}\NormalTok{, marker}\OperatorTok{=}\StringTok{\textquotesingle{}o\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{"$q\_1=(}\SpecialCharTok{\{:.4f\}}\StringTok{,}\SpecialCharTok{\{:.4f\}}\StringTok{)$"}\NormalTok{.}\BuiltInTok{format}\NormalTok{(x1, y1))}
\NormalTok{ax.plot(x2,y2,color}\OperatorTok{=}\StringTok{\textquotesingle{}tab:green\textquotesingle{}}\NormalTok{, marker}\OperatorTok{=}\StringTok{\textquotesingle{}o\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{"$q\_1=(}\SpecialCharTok{\{:.4f\}}\StringTok{,}\SpecialCharTok{\{:.4f\}}\StringTok{)$"}\NormalTok{.}\BuiltInTok{format}\NormalTok{(x2, y2))}
\NormalTok{ax.plot(x3,y3,color}\OperatorTok{=}\StringTok{\textquotesingle{}tab:red\textquotesingle{}}\NormalTok{, marker}\OperatorTok{=}\StringTok{\textquotesingle{}o\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{"$q\_1=(}\SpecialCharTok{\{\}}\StringTok{,}\SpecialCharTok{\{\}}\StringTok{)$"}\NormalTok{.}\BuiltInTok{format}\NormalTok{(x3, y3))}
...
{\centering \includegraphics[width=0.8\linewidth]{bookdown_intro_files/figure-latex/nice-fig-5} 
