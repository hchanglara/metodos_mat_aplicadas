...
:::{.exercise}
Sea $u$ tal que $\partial_t u = \Delta u$. Calcula $\lim_{t\to\infty} u(t)$ en términos de $u(0)$\footnote{Solución: $\lim_{t\to\infty} u(t) = \frac{1}{M}\sum_{x\in V}u(x,0)$}. 
:::
...
Procedamos a calcular el espectro del Laplaciano sobre el toro (Ejercicio \ref{ejer:toro}). Asumamos la hipótesis de \textbf{separación de variables}
$$
...
{\color{red}Integración numérica}
